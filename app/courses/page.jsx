        ...
        {loading ? (
          ...
          <div className="flex flex-col gap-6 w-11/12 mx-auto">
            {courses.map((course) => (
              <div
                key={course._id}
                className="w-full bg-white border border-gray-300 rounded-lg shadow-md p-6 flex flex-col md:flex-row gap-6 transition-all hover:shadow-xl hover:border-emerald-500"
              >
                <div className="flex-shrink-0 w-32 h-32 bg-gray-300 rounded-lg"></div>
                <div className="flex flex-col gap-4">
                  <h2 className="text-lg font-semibold text-gray-800 hover:text-emerald-500 transition-all">
                    {course["Course Name"]}
                  </h2>
                  ...
                  <div className="flex flex-wrap gap-2">
                    <span className="inline-block bg-emerald-500 text-white text-xs px-3 py-1 rounded-full">
                      {course.Topic}
                    </span>
                    <span className="inline-block bg-emerald-600 text-white text-xs px-3 py-1 rounded-full">
                      {course.Level}
                    </span>
