...
const Page = () => {
  ...
  return (
    <div >
      <div className="space-y-2 py-10 bg-blue-400 W ">
        ...
        {loading ? (
          ...
          <div className="flex flex-col gap-6 w-11/12 mx-auto">
            {courses.map((course) => (
              <div
                key={course._id}
                className="w-full bg-white border border-gray-300 rounded-lg shadow-md p-6 flex flex-col md:flex-row gap-6 transition-all hover:shadow-xl hover:border-blue-500"
              >
                <div className="flex-shrink-0 w-32 h-32 bg-gray-300 rounded-lg"></div>
                <div className="flex flex-col gap-4">
                  <h2 className="text-lg font-semibold text-gray-800 hover:text-blue-600 transition-all">
                    {course["Course Name"]}
                  </h2>
