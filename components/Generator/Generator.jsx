...
const Generator = () => {
    ...
    const handleForm = async (e) => {
        ...
        if (!duration || isNaN(duration) || !noOfChapters || isNaN(noOfChapters)) {
            return Swal.fire({
                icon: "error",
                title: "Invalid input!",
                text: "Duration and Number of Chapters must be valid numbers.",
            });
        }
        ...
        try {
            ...
            if (response.insertedId) {
                Swal.fire({
                    position: "top",
                    icon: "success",
                    title: "✅ Your course generated successfully!",
    ...
    return (
        <div className="bg-white shadow-xl mx-auto p-8 sm:p-12 border border-gray-100 rounded-3xl max-w-4xl my-10">
            <h2 className="mb-12 font-semibold text-gray-800 text-3xl sm:text-4xl text-center">
                🚀 Create Your Course
            </h2>
            ...
            <form onSubmit={handleForm} className="gap-10 grid grid-cols-1 md:grid-cols-2">
                ...
                <div className="space-y-8">
                    <div className="flex flex-col">
                        ...
                        <select name="category" required className="p-4 border border-gray-300 rounded-xl focus:ring-2 focus:ring-teal-500">
                    ...
                    <div className="flex flex-col">
                        ...
                        <select name="topic" required className="p-4 border border-gray-300 rounded-xl focus:ring-2 focus:ring-teal-500">
                    ...
                    <div className="flex flex-col">
                        ...
                        <select name="level" className="p-4 border border-gray-300 rounded-xl focus:ring-2 focus:ring-teal-500">
                ...
                <div className="space-y-8">
                    <div className="flex flex-col">
                        <label className="block font-semibold text-gray-700 text-lg">⏳ Course Duration (hours)</label>
                        <input
                            type="text"
                            name="duration"
                            required
                            className="p-4 border border-gray-300 rounded-xl focus:ring-2 focus:ring-teal-500"
                        />
                    </div>
                ...
                <div className="flex justify-center col-span-2 mt-8">
                    <button
                        ...
                        className="bg-teal-600 hover:bg-teal-700 px-6 py-3 rounded-lg text-white font-medium transition-transform hover:scale-105"
                    >
                        {isGenerating ? "⏳ Generating..." : "🎯 Create Course Generator"}
                    </button>
                </div>
            </form>
        </div>
