...
export default function HeroBanner() {
  ...
  return (
    <section className="relative flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-blue-600 to-indigo-900 text-white text-center px-6 overflow-hidden">
      ...
      />
      <motion.div
        className="absolute top-1/3 left-1/4 w-24 h-24 bg-white opacity-20 rounded-full blur-2xl"
        animate={{ y: [0, -20, 0], x: [0, 10, 0] }}
        transition={{ repeat: Infinity, duration: 4, ease: "easeInOut" }}
      />
      <motion.div
        className="absolute bottom-1/3 right-1/4 w-32 h-32 bg-yellow-300 opacity-30 rounded-full blur-2xl"
        animate={{ y: [0, 20, 0], x: [0, -10, 0] }}
      ...
      <div className="relative z-10 max-w-3xl">
        ...
        <motion.button
          className="px-8 py-3 bg-yellow-400 text-gray-900 rounded-lg font-bold hover:bg-yellow-500 transition-all shadow-lg"
      ...
      <div className="relative mt-12 w-full max-w-4xl z-10">
        <Slider {...settings}>
