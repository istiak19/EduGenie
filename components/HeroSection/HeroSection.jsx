...
const HeroSection = () => {
    return (
        <div className="bg-[#fafafa] dark:bg-gray-900 transition-colors duration-500 text-center py-24 px-6 md:px-10">
            {/* Small Title */}
            ...
            {/* Subheading */}
            <p className="text-gray-600 dark:text-gray-300 mt-8 max-w-2xl mx-auto text-lg">
            ...
            {/* Features */}
            <div className="flex flex-wrap justify-center items-center gap-6 font-semibold text-gray-800 dark:text-gray-100 mt-10">
                {['Learn', 'Grow', 'Innovate', 'Lead', 'Achieve'].map((item) => (
                    <span
                        key={item}
                        className="flex items-center gap-2 bg-white dark:bg-gray-800 px-4 py-2 rounded-md transition-colors"
                    >
