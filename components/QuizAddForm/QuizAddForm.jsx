  ...
  return (
    <div className="max-w-4xl mx-auto py-8 px-4 md:px-6">
      ...
      <div className="bg-white shadow-lg rounded-xl p-6 md:p-10 border border-gray-200">
        <h2 className="text-lg md:text-2xl font-bold mb-6 text-center text-teal-800">Add New Quiz</h2>
          ...
          {selectedTopic && (
            <div className="text-center">
              <button
                type="submit"
                disabled={loading}
                className={`w-full md:w-auto px-6 py-2 text-white rounded font-medium transition duration-200 ${
